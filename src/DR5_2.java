...
public class DR5_2 implements ItemListener{
	...
	DR5_2()throws InterruptedException, IOException
	{
		frm=new JFrame();
	  ...
	  //  frm.setLocation(350, 100);
    	...
    	do
	    {
			...
			//	System.out.println(count);
				...
				if((Math.abs(new_x-old_x)>5 || Math.abs(new_y-old_y)>5)&&count>500)
				{			
					java.awt.Point p;
				...
				else if(count>s_count*1.3 && count>500)
				{
