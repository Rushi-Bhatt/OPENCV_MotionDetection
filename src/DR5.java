...
public class DR5 implements ItemListener{
	...
	DR5()throws InterruptedException, IOException
	{
		frm=new JFrame();
    ...
    jtb.addItemListener(this);
    	...
    	do
	    {
		 ...
		 /*   label_1.setPreferredSize(new Dimension(sx,sy));
	...
	/*	fac_x=(int)((1200-old_x)/(630-old_x));
		...
		r.mouseMove((int) (old_x+frm.getLocation().getX()),(int) (old_y+frm.getLocation().getY()));
		mx=old_x+10;
		my=old_y+10;
	}
